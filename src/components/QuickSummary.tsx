      ...
      const response = await fetch('/api/ai/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'Você é um jornalista especializado em criar resumos em tópicos. Responda sempre em português brasileiro. Crie exatamente 4 tópicos com bullet points (•) destacando os pontos principais da notícia.'
            },
            {
              role: 'user',
              content: `Crie um resumo em 4 tópicos desta notícia:\n\n${textContent}`
            }
          ],
          max_tokens: 200,
          temperature: 0.7,
